...
const DEFAULTS = {
  ...
  // Advanced, machine-local (NOT synced — must stay out of preferences.SYNCABLE_KEYS):
  // reveal customer-user accounts, not just Datarails support accounts. Default off.
